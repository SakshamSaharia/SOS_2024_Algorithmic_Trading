...
slv.loc[:, '9-day'] = slv['Close'].rolling(window=9,min_periods=1).mean()
slv.loc[:, '21-day'] = slv['Close'].rolling(window=21,min_periods=1).mean()
...
slv['system_return'] = slv['return']*slv['signal']
